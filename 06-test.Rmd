...
```{r one_sample_ttest_data_chap06}
set.seed(1234)
...
```{r two_sample_ttest_data_chap06}
set.seed(1234)
...
```{r two_sample_ttest_paired_chap06}
...
```{r ANOVA_sampledata_mean_chap06}
...
```{r ANOVA_1_paired_3_chap06, eval=FALSE, include=FALSE}
...
```{r renshu_3_2_chap06, echo=FALSE}
