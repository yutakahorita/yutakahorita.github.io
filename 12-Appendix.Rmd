...
```{r ggplot2_scatterplot_Appendix}
...
```{r ggplot2_scatterplot_Appendix_basis}
...
```{r ggplot2_histogram_chap03, message=FALSE, warning=FALSE}
...
```{r ggplot2_boxplot_chap03, message=FALSE, warning=FALSE}
...
```{r ggplot2_violin_chap03, message=FALSE, warning=FALSE}
...
```{r graph_label, message=FALSE, warning=FALSE}
...
```{r graph_facet, message=FALSE, warning=FALSE}
...
```{r graph_theme, message=FALSE, warning=FALSE}
...
```{r qplot_scatterplot_Appendix, message=FALSE, warning=FALSE}
...
```{r graph_save, message=FALSE, warning=FALSE}
...
```{r readr_1_Appendix, message=FALSE}
...
```{r summarise_Appendix, message=FALSE}
...
```{r making_plot_Appendix, message=FALSE}
...
```{r mutate_Appendix, message=FALSE}
...
```{r write_excel_Appendix, eval=FALSE, message=FALSE}
...
```{r logstic_data_result_chap10App}
y = -5.16017 + 0.93546 * 1
y
```
...
```{r logstic_data_result2_chap10App}
exp(0.94)
```
...
```{r logstic_data_result2_2_chap10App}
...
```{r logstic_data_result2_3_chap10App}
1/(1+exp(-1*y))
```
