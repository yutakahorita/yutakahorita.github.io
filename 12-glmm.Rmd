...
graph_lm = ggplot2::ggplot()+
  ggplot2::geom_point(data = iris, aes(x = Sepal.Length, y = Sepal.Width), size = 3)  +
  ggplot2::geom_smooth(data = iris, aes(x = Sepal.Length, y = Sepal.Width), formula = y~ 1 + x, method = "lm", se = FALSE)
graph_lm
...
graph_2 = ggplot2::ggplot() +
  ggplot2::geom_point(data = iris, aes(x = Sepal.Length, y = Sepal.Width, color = Species, shape = Species), size = 3) 
graph_2
